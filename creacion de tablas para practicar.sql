...
--2. List rut, concatenate first name and last name and name it as "full_name" from clients who
-----have products in the city "Melipeuco"
...
--5. The board of directors is requesting know the locations, accounts numbers and balances
-----which are loans with balance greater than 90000 and were issued in 2011
...
-- CREAR TABLA customers e inserción 
create table CUSTOMERS (
id number primary key, first_name varchar(50) not null, last_name varchar(50) not null, 
email varchar(50) not null, address varchar(50) not null, phone varchar(50) not null, rut varchar(50)not null);
...
-- creación dela tabla LOCATIONS e inserción 
create table LOCATIONS (
id number primary key, city varchar(50) not null, manager_first_name varchar(50) not null, manager_last_name varchar(50) not null);
...
-- create table accounts e inserción 
create table ACCOUNTS (id number, type varchar(50), aperture_date DATE, balance DECIMAL(15,2), 
customer_id DECIMAL(15,2), location_id DECIMAL(15,2));
